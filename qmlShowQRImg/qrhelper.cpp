...
QPixmap QRHelper::generateQR(QString strContent ,int width,int height)
{
    ...
    {
        QImage defaultImg = QImage(1, 1, QImage::Format_ARGB32);
        return GenQRPixmap.fromImage(defaultImg);
    }
...
void QRHelper::setQRContent(QString strContent)
{
    m_strtxt = strContent;
}

QString QRHelper::getQRContent()
{
    return m_strtxt;
}
